...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/dramamoorthy/PycharmProjects/TestProjects/remove-bg'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/dramamoorthy/PycharmProjects/TestProjects/remove-bg/bin/deactivate.nu'
